...
import { FaUpload, FaSpinner, FaTrash, FaFile } from 'react-icons/fa'
          ...
          {files.map(file => (
            ...
            >
              <div className="flex items-center">
                <div className="w-8 h-8 flex items-center justify-center bg-neutral-100 rounded">
                  <FaFile className="text-neutral-500" />
                </div>
